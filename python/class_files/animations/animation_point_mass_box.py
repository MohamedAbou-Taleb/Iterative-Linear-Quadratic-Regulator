...
class AnimationPointMassBox:
    ...
    def create_environment(self):
        ...
        sphere_1.SetThetaResolution(32); sphere_1.SetPhiResolution(32)
        
        _H_ball1 = vtk.vtkMatrixToLinearTransform(); _H_ball1.SetInput(self.H_ball1)
        tf_filter_1 = vtk.vtkTransformPolyDataFilter()
        tf_filter_1.SetInputConnection(sphere_1.GetOutputPort()); tf_filter_1.SetTransform(_H_ball1)
        
        mapper_1 = vtk.vtkPolyDataMapper(); mapper_1.SetInputConnection(tf_filter_1.GetOutputPort())
        actor_ball1 = vtk.vtkActor(); actor_ball1.SetMapper(mapper_1)
        ...
        sphere_2.SetThetaResolution(32); sphere_2.SetPhiResolution(32)
        
        _H_ball2 = vtk.vtkMatrixToLinearTransform(); _H_ball2.SetInput(self.H_ball2)
        tf_filter_2 = vtk.vtkTransformPolyDataFilter()
        tf_filter_2.SetInputConnection(sphere_2.GetOutputPort()); tf_filter_2.SetTransform(_H_ball2)
        
        mapper_2 = vtk.vtkPolyDataMapper(); mapper_2.SetInputConnection(tf_filter_2.GetOutputPort())
        actor_ball2 = vtk.vtkActor(); actor_ball2.SetMapper(mapper_2)
        ...
        _H_box = vtk.vtkMatrixToLinearTransform(); _H_box.SetInput(self.H_box)
        tf_filter_box = vtk.vtkTransformPolyDataFilter()
        tf_filter_box.SetInputConnection(box_geom.GetOutputPort()); tf_filter_box.SetTransform(_H_box)
        
        mapper_box = vtk.vtkPolyDataMapper(); mapper_box.SetInputConnection(tf_filter_box.GetOutputPort())
        actor_box = vtk.vtkActor(); actor_box.SetMapper(mapper_box)
        actor_box.GetProperty().SetColor([144/255, 213/255, 255/255]) # Dark Green

        # 4. Floor
        floor = vtk.vtkCubeSource()
        floor.SetXLength(4.0); floor.SetYLength(0.02); floor.SetZLength(2.0)
    ...
    def animate(self, save_video=False, filename="box_manipulation.mp4", 
