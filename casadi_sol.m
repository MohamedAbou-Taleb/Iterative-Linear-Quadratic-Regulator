...
% Plot States
subplot(3, 1, 1);
plot(tspan, X_bar_casadi(1, :), 'b-', 'LineWidth', 2);
hold on;
% plot(tspan, X_closed_form(1, :), 'r--', 'LineWidth', 2);
title('Optimal State Trajectory');
xlabel('Time (s)');
ylabel('State');
legend('iLQR', 'closed form');
grid on;

subplot(3, 1, 2)
plot(tspan, X_bar_casadi(2, :), 'b-', 'LineWidth', 2);
hold on;
% plot(tspan, X_closed_form(2, :), 'r--', 'LineWidth', 2);
title('Optimal State Trajectory');
xlabel('Time (s)');
ylabel('State');
...
hold on
plot(tspan(1:N), U_bar_casadi, 'k-', 'LineWidth', 2);
% plot(tspan, U_closed_form, LineStyle="--", LineWidth=2)
